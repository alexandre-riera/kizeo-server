...
use App\Repository\MailS80Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS80Repository::class)]
class MailS80
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS80s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS80 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS80
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS80 $id_contact): static
    {
