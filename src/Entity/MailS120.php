...
use App\Repository\MailS120Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS120Repository::class)]
class MailS120
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS120s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS120 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS120
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS120 $id_contact): static
    {
