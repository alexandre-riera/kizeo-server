...
use App\Repository\MailS170Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS170Repository::class)]
class MailS170
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS170s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS170 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS170
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS170 $id_contact): static
    {
