...
use App\Repository\MailS140Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS140Repository::class)]
class MailS140
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS140s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS140 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS140
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS140 $id_contact): static
    {
