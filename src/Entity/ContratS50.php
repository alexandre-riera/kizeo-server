...
use App\Repository\ContratRepositoryS50;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ContratRepositoryS50::class)]
class ContratS50
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    /**
     * @var Collection<int, EquipementS50>
     */
    #[ORM\OneToMany(targetEntity: EquipementS50::class, mappedBy: 'contratS50')]
    ...
    /**
     * @return Collection<int, EquipementS50>
     */
    ...
    public function addEquipement(EquipementS50 $equipement): static
    {
        if (!$this->equipements->contains($equipement)) {
            $this->equipements->add($equipement);
            $equipement->setContratS50($this);
        }

        return $this;
    }

    public function removeEquipement(EquipementS50 $equipement): static
    {
        if ($this->equipements->removeElement($equipement)) {
            // set the owning side to null (unless already changed)
            if ($equipement->getContratS50() === $this) {
                $equipement->setContratS50(null);
            }
        }
