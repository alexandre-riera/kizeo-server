...
use App\Repository\ContratRepositoryS160;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ContratRepositoryS160::class)]
class ContratS160
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    /**
     * @var Collection<int, EquipementS160>
     */
    #[ORM\OneToMany(targetEntity: EquipementS160::class, mappedBy: 'contratS160')]
    ...
    /**
     * @return Collection<int, EquipementS160>
     */
    ...
    public function addEquipement(EquipementS160 $equipement): static
    {
        if (!$this->equipements->contains($equipement)) {
            $this->equipements->add($equipement);
            $equipement->setContratS160($this);
        }

        return $this;
    }

    public function removeEquipement(EquipementS160 $equipement): static
    {
        if ($this->equipements->removeElement($equipement)) {
            // set the owning side to null (unless already changed)
            if ($equipement->getContratS160() === $this) {
                $equipement->setContratS160(null);
            }
        }
