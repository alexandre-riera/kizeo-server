...
use App\Repository\ContratRepositoryS80;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ContratRepositoryS80::class)]
class ContratS80
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    /**
     * @var Collection<int, EquipementS80>
     */
    ...
    /**
     * @return Collection<int, EquipementS80>
     */
    ...
    public function addEquipement(EquipementS80 $equipement): static
    {
        if (!$this->equipements->contains($equipement)) {
            $this->equipements->add($equipement);
            $equipement->setContratS80($this);
        }

        return $this;
    }

    public function removeEquipement(EquipementS80 $equipement): static
    {
        if ($this->equipements->removeElement($equipement)) {
            // set the owning side to null (unless already changed)
            if ($equipement->getContratS80() === $this) {
