...
use App\Repository\MailS70Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS70Repository::class)]
class MailS70
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS70s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS70 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS70
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS70 $id_contact): static
    {
