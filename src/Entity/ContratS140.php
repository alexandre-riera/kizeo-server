...
use App\Repository\ContratRepositoryS140;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ContratRepositoryS140::class)]
class ContratS140
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    /**
     * @var Collection<int, EquipementS140>
     */
    #[ORM\OneToMany(targetEntity: EquipementS140::class, mappedBy: 'contratS140')]
    ...
    /**
     * @return Collection<int, EquipementS140>
     */
    ...
    public function addEquipement(EquipementS140 $equipement): static
    {
        if (!$this->equipements->contains($equipement)) {
            $this->equipements->add($equipement);
            $equipement->setContratS140($this);
        }

        return $this;
    }

    public function removeEquipement(EquipementS140 $equipement): static
    {
        if ($this->equipements->removeElement($equipement)) {
            // set the owning side to null (unless already changed)
            if ($equipement->getContratS140() === $this) {
                $equipement->setContratS140(null);
            }
        }
