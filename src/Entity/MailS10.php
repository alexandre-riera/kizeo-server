...
use App\Repository\MailS10Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS10Repository::class)]
class MailS10
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS10s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS10 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS10
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS10 $id_contact): static
    {
