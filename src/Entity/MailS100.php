...
use App\Repository\MailS100Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS100Repository::class)]
class MailS100
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS100s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS100 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS100
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS100 $id_contact): static
    {
