...
use App\Repository\MailS50Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS50Repository::class)]
class MailS50
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS50s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS50 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS50
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS50 $id_contact): static
    {
