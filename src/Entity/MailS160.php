...
use App\Repository\MailS160Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS160Repository::class)]
class MailS160
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS160s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS160 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS160
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS160 $id_contact): static
    {
