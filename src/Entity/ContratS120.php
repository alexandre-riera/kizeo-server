...
use App\Repository\ContratRepositoryS120;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ContratRepositoryS120::class)]
class ContratS120
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    /**
     * @var Collection<int, EquipementS120>
     */
    #[ORM\OneToMany(targetEntity: EquipementS120::class, mappedBy: 'contratS120')]
    ...
    /**
     * @return Collection<int, EquipementS120>
     */
    ...
    public function addEquipement(EquipementS120 $equipement): static
    {
        if (!$this->equipements->contains($equipement)) {
            $this->equipements->add($equipement);
            $equipement->setContratS120($this);
        }

        return $this;
    }

    public function removeEquipement(EquipementS120 $equipement): static
    {
        if ($this->equipements->removeElement($equipement)) {
            // set the owning side to null (unless already changed)
            if ($equipement->getContratS120() === $this) {
                $equipement->setContratS120(null);
            }
        }
