...
use App\Repository\MailS60Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS60Repository::class)]
class MailS60
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS60s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS60 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS60
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS60 $id_contact): static
    {
