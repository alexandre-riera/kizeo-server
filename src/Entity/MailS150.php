...
use App\Repository\MailS150Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS150Repository::class)]
class MailS150
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS150s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS150 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS150
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS150 $id_contact): static
    {
