...
use App\Repository\MailS40Repository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MailS40Repository::class)]
class MailS40
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'mailS40s')]
    #[ORM\JoinColumn(nullable: false)]
    private ?ContactS40 $id_contact = null;
    ...
    public function getIdContact(): ?ContactS40
    {
        return $this->id_contact;
    }

    public function setIdContact(?ContactS40 $id_contact): static
    {
